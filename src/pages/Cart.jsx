                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted mb-0">Unit Price: ${product.price}</p>
                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={handlePayNow}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="number" className="form-control" placeholder="0000 0000 0000 0000" required />
                                </div>
                                <div className="row mb-4">
                                    <div className="col-7">
                                        <label className="form-label small fw-bold">EXPIRATION</label>
                                        <input type="number" className="form-control" placeholder="MM / YY" required />
                                    </div>
                                    <div className="col-5">
                                        <label className="form-label small fw-bold">CVV</label>
                                        <input type="number" className="form-control" placeholder="123" required />
                                    </div>
                                </div>
                                <hr/>  
